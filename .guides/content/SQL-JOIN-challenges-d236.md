For ease of use, the way in which you are going to complete challenges in the following sections is by writing the SQL `SELECT` statements into `*.sql` files.
